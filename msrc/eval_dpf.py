...
def eval(model, dataloader_eval, epoch=5, post_process=False):
    ...
    for _, eval_sample_batched in enumerate(tqdm(dataloader_eval.data)):
        with torch.no_grad():
            ...
            #     depth1_flipped, u1_flipped, depth2_flipped, u2_flipped, _, _,final_depth_flipped,_,_,_,_= model(image_flipped, inv_K, epoch)
                
            #     pred_depth = post_process_depth(final_depth, final_depth_flipped)
