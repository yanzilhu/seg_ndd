...
parser.add_argument('--checkpoint_path',type=str,   help='path to a checkpoint to load', default='debug_models/1120/nddepth_nyu_debug/model-3000-best_abs_rel_0.13122')
