...
parser.add_argument('--checkpoint_path',type=str,   help='path to a checkpoint to load', default='debug_models/1217/nddepth_nyu_debug/model-132000-best_rms_0.31645')
    ...
    with torch.no_grad():
        ...
        if args.dataset == 'kitti':
            ...
            try:
                ...
                out_ply = 'mytest/ply/predicted_epoch_5.ply'
